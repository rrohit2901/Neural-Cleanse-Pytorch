...
def inject_backdoor():
    ...
    model.fit(train_gen, epochs = 30, verbose = 1, steps_per_epoch = int(number_images//BATCH_SIZE), learning_rate = lr, loss = loss, change_lr_every = 10, test_gen = test_adv_gen, stps = stps, model_path = MODEL_FILEPATH)
